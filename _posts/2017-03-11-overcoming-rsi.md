...
It's `ctrl+T` shortcut, and if you stretch for the keys, you can perform it only with the left hand.
...
I was used to working for hours without breaks. However when you’re 23 and your hands on the way to trash-town, you're gonna have to suck it up.

...
I also wanted to try out Mistral as an LLM, specifically I had a small web scraping task that I figured I would test it out at[^0]. It's, not great. It's doing the thing the frontier models used where it'd say something was "perfect" and "fantastic", when it doesn't work at all, which is a tad disappointing.
...
[^0]: While I'm skeptical of LLMs for a fair amount of tasks, I feel like one-off web-scraping scripts is something they should be a perfect fit for.